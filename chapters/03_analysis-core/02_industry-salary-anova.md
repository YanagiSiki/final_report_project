...
在執行分析前，數據已通過**常態性檢定 (Shapiro-Wilk test, p > .05)** 與**變異數同質性檢定 (Levene's test based on median, p > .05)**，滿足 ANOVA 的前提假設。
...
綜合描述性統計與事後檢定 (Tukey HSD) 的結果，台灣的產業薪資結構呈現出清晰的**三級階層化 (Three-Tier Hierarchy)** 現象：
