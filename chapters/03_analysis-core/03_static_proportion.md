...
- **群類分布**：
  - **高薪高佔比**：如「電機與電子群資電類」與「衛生與護理類」，位於圖表右上方，符合高薪吸引人才的預期。
  - **低薪高佔比**：值得注意的是「餐旅群」與「商業與管理群」，雖然平均薪資相對較低，但仍擁有極高的報名佔比，顯示這些領域可能存在非金錢的吸引力（如入門門檻、興趣導向等），這也是模型 $R^2$ 較低的原因之一。
...
這意味著，在長期均衡狀態下，薪資較高的產業，其對應的科系確實傾向佔據較大的生源版圖。
