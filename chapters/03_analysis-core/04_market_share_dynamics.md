...
統計結果顯示，在以 3 年為週期的短期變動中，薪資成長率對市佔率成長率的解釋力並不顯著（p > 0.05）。這與前述的長期軌跡分析看似矛盾，實則揭示了學生選擇行為的重要特徵：

1.  **反應滯後性與長期性**：學生對產業前景的判斷往往基於長期印象，而非短期的薪資波動。因此，雖然短期（3 年）的數據關聯不明顯，但拉長至 14 年的軌跡圖（Section 3.4.2）卻能清晰看見高薪產業市佔率提升的趨勢。
2.  **結構性因素主導**：技職體系的群類消長是一個長期累積的過程。薪資的「吸納效應」並非一蹴可幾，而是透過長期的薪資優勢，潛移默化地改變了家長與學生的選擇偏好。

綜上所述，雖然短期迴歸未達顯著水準，但結合長期軌跡分析，我們仍可確認薪資結構對科系市佔率具有長期的引導作用。
