...
2.  **薪資對學生選擇的影響機制 (3.3 & 3.4 節)**：
    ...
    - **長期吸納效應與中期存量支撐 (3.4 節)**：透過長期的產業軌跡分析，我們發現部分高薪群類（如衛護、機械）呈現穩定的「向右上方」移動趨勢，證實了長期吸納效應的存在。進一步的「3 年週期分析」顯示，**中期平均薪資與平均市佔率呈現邊緣顯著的正相關 ($p \approx 0.05$)**。這補充了靜態模型的發現，證實了「高薪吸引學生」的經濟邏輯在中長期平均上仍然運作，並非僅是短期現象。

**本章核心結論：**

本研究最關鍵的發現是：**在少子化時代，薪資是驅動生源流動的關鍵磁鐵，但其作用機制是「存量導向」而非「流量導向」。**

1.  **存量 (Stock) 決定勝負**：學生對「絕對薪資水準」高度敏感。那些已經建立起高薪形象的領域（如半導體、醫療），能夠在少子化浪潮中逆勢吸納更多比例的學生。3 年週期的分析也支持此點，顯示中期的平均高薪仍能帶來較高的市佔率。
2.  **流量 (Flow) 影響有限**：學生對「薪資成長率」反應冷淡。短期的加薪幅度難以直接轉化為立即的生源增長。這反映了教育選擇的保守性與資訊傳遞的滯後。
...
3.  **動態層次（Dynamics）：薪資「流量」無效（成長率脫鉤）**
    ...
    - 動態模型顯示，**「薪資成長率（Flow）」與「市佔率成長率」並無顯著關聯 (p > 0.05)**。
    - 3 年週期分析則進一步補充，即使在中期，驅動市佔率的仍是「平均薪資水準（Stock）」而非「成長率」。
