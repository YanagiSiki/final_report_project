...
2.  **個體層次（Micro）：薪資「存量」決定市佔率版圖（拉力）**
    ...
    - 靜態模型與軌跡分析證實，**「絕對薪資水準（Stock）」與「科系市佔率」呈現顯著正相關 (p < 0.01)**。雖然統計模型顯示解釋力有限（$R^2$ 偏低），顯示仍有非經濟因素影響，但整體而言，高薪產業（如醫護）憑藉著長期累積的薪資優勢，成功在縮小的生源餅圖中維持甚至搶佔了更大的份額，產生了明確的「吸納效應 (Attraction Effect)」。
...
1.  **對教育單位**：
    ...
    - 對於高薪科系（如醫護、電資），應確保教學品質與資源投入，以鞏固其核心人才培育優勢。
